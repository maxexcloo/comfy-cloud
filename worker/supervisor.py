...
from catalogue.fetch import fetch_profile, prune_profiles
from worker.config import DeploymentType
from worker.logs import capture_process_logs
...
def _start_gateway(
    ...
    return subprocess.Popen(
        [
            ...
            "-m",
            "uvicorn",
            f"worker.app:create_{deployment_type}_app",
            "--factory",
            "--host",
            host,
            "--port",
