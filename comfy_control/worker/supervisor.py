...
from comfy_control.worker.config import DeploymentType
from comfy_control.worker.logs import capture_process_logs
...
def _start_gateway(
    ...
    return subprocess.Popen(
        [
            ...
            "-m",
            "uvicorn",
            f"comfy_control.worker.app:create_{deployment_type}_app",
            "--factory",
            "--host",
            host,
            "--port",
