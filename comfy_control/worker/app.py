...
from comfy_control.worker.auth import request_authorised, websocket_authorised
from comfy_control.worker.config import Settings
from comfy_control.worker.execution import (
    ExecutionOutput,
    ExecutionRequest,
    ExecutionResult,
)
from comfy_control.worker.logs import entries as worker_log_entries
from comfy_control.worker.runtime import GenerationQueueFull, Runtime
        ...
        return JSONResponse(
            {
                ...
                "status": "ready" if object_info is not None else "starting",
