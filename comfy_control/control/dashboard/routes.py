...
from comfy_control.control.dashboard.auth import ui_authorised, valid_csrf
from comfy_control.control.dashboard.rendering import (
    pagination_context,
    render_dashboard,
)
...
DASHBOARD_CSS = (
    resources.files("comfy_control.control.dashboard")
    .joinpath("static", "dashboard.css")
    .read_text()
)
DASHBOARD_JS = (
    resources.files("comfy_control.control.dashboard")
