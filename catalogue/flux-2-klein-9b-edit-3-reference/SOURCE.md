...
The template's subgraph was flattened into ComfyUI API format. The third reference
repeats its documented scale, VAE-encode, and ordered `ReferenceLatent` chain for
both positive and zeroed conditioning; first-reference output dimensions are kept.
